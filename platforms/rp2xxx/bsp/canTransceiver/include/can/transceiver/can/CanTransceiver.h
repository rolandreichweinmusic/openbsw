...
public:
    ...
    bool wokenUp()
    {
        // return fFlexCANDevice.wokenUp();
        return {};
    }

    uint32_t getBaudrate() const override
    {
        // return fFlexCANDevice.getBaudrate();
        return {};
    }
    ...
    {
        (void)transceiverIndex; // not implemented yet
#if 0
     ...
     */
    static CanFlex2Transceiver** getAllCanFlex2Transceivers()
    {
        // return fpCanTransceivers;
        return {};
    }
...
private:
    ...
    void notifyRegisteredSentListener(::can::CANFrame const& frame)
    {
